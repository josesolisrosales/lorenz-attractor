...
class TestCLIParser:
    ...
    def test_sweep_command_required_args(self):
        ...
        parser = create_parser()
        args = parser.parse_args(['sweep', '--parameter', 'rho', '--range', '20', '30'])
    ...
    def test_bifurcation_command_required_args(self):
        ...
        parser = create_parser()
        args = parser.parse_args(
            ['bifurcation', '--parameter', 'rho', '--range', '0', '50']
        )
    ...
    def test_analysis_command_required_args(self):
        ...
        parser = create_parser()
        args = parser.parse_args(['analysis', '--type', 'lyapunov'])
...
class TestCLICommands:
    ...
    def test_cmd_simulate_basic(
        self, mock_print, mock_simulator_class, mock_lorenz_class
    ):
    ...
    @patch('builtins.print')
    def test_cmd_simulate_random_ic(
        self, mock_print, mock_ic_class, mock_simulator_class, mock_lorenz_class
    ):
    ...
    @patch('lorenz_attractor.cli.Simulator')
    @patch('builtins.print')
    def test_cmd_simulate_with_data_export(
        self, mock_print, mock_simulator_class, mock_lorenz_class, mock_exporter_class
    ):
