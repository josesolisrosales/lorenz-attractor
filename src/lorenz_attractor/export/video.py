...
class VideoExporter:
    ...
    def export_trajectory_animation(
        self,
        ...
        if video_duration:
            ...
            frame_indices = np.arange(
                0, total_frames, max(1, total_frames // (settings['fps'] * 10))
            )
    ...
    def export_parameter_sweep_video(
        self,
    ...
    def export_multi_trajectory_video(
        self,
        results: List[SimulationResult],
        filename: str,
        ...
        # Create animation
        anim = FuncAnimation(
            fig, animate, frames=max_length, interval=1000 / settings['fps'], blit=True
        )
    ...
    def export_rotating_view_video(
        self,
        result: SimulationResult,
        filename: str,
        ...
        # Create animation
        anim = FuncAnimation(
            fig, animate, frames=num_frames, interval=1000 / settings['fps'], blit=False
        )
