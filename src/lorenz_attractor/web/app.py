...
def create_app() -> dash.Dash:
                    ...
                    html.Div(
                        [
                            ...
                            html.Div(
                                [
                                    html.H3(
                                        "System Parameters", style={'color': '#34495e'}
                                    ),
                                    html.Label(
                                        "Sigma (σ):", style={'fontWeight': 'bold'}
                                    ),
                                    dcc.Slider(
                                        id='sigma-slider',
                                        min=0.1,
                                    ...
                                    html.Hr(),
                                    html.H3(
                                        "Initial Conditions", style={'color': '#34495e'}
                                    ),
                                    html.Div(
                                        [
                                            html.Div(
                                    ...
                                    html.Label(
                                        "Number of Steps:", style={'fontWeight': 'bold'}
                                    ),
                                    dcc.Slider(
                                        id='steps-slider',
                                        min=1000,
                            ...
                            html.Div(
                                [
                                    dcc.Tabs(
                                        ...
                                        children=[
                                            dcc.Tab(
                                                label='3D Trajectory', value='3d-plot'
                                            ),
                                            dcc.Tab(
                                                label='2D Projections',
                                                value='2d-projections',
                                            ),
                                            dcc.Tab(
                                    ...
                                    html.Div(
                                        id='plot-container', style={'marginTop': '20px'}
                                    ),
                                    # Real-time controls
                                    html.Div(
                                        [
    ...
    def run_simulation(
        ...
        config = SimulationConfig(
            dt=dt, num_steps=num_steps, integration_method=integration_method
        )
    ...
    def update_visualization(active_tab, simulation_data):
        ...
        try:
            ...
            if active_tab == '3d-plot':
                ...
                fig.add_trace(
                    go.Scatter(
                        x=freqs[1 : len(freqs) // 2],
                        y=power[1 : len(freqs) // 2],
                        mode='lines',
                        name='Power Spectrum',
                    ),
                    row=2,
